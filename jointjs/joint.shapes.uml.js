...
joint.shapes.uml.CustomState = joint.shapes.basic.Generic.extend({

    markup: [
        '<g class="rotatable">',
          '<g class="scalable">',
          	'<g class="wrapped">',
          		'<rect class="uml-state-wrapper"/>',
          		'<image class="state-connector"/>',
          	'</g>',
            '<rect class="uml-state-body"/>',            
          '</g>',
          '<path class="uml-state-separator"/>',
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
        	...
        	'.state-connector': {
        		'ref-x': 170, 'ref-y': 78, width: 25, height: 25 //, ref: 'rect'
        	},
        	'.uml-state-wrapper': {
                'width': 200, 'height': 260, 'rx': 10, 'ry': 10,
                'fill': '#ecf0f1', 'stroke': '#bdc3c7', 'stroke-width': 3
            },
            '.uml-state-body': {
                'width': 200, 'height': 200, 'rx': 10, 'ry': 10,
